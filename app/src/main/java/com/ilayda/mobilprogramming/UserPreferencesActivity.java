...
public class UserPreferencesActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        RelativeLayout ll = (RelativeLayout) findViewById(R.id.preferencesLayout);
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(aSwitch.isChecked()){
                    SharedPreferences.Editor edito = getSharedPreferences("MYPREFS", MODE_PRIVATE).edit();
                    edito.putBoolean("darkmod", true);
                    edito.commit();
                    edito.apply();
                    ...
                    SharedPreferences.Editor edito = getSharedPreferences("MYPREFS", MODE_PRIVATE).edit();
                    edito.putBoolean("darkmod", false);
                    edito.commit();
                    edito.apply();
                ...
                Toast.makeText(getApplicationContext(),"Your informations are saved!", Toast.LENGTH_LONG).show();
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        if(requestCode == SELECT_IMAGE && resultCode == RESULT_OK){ //RESULT_OK --> Kullanici secim yapabilmis.
            ...
            Toast.makeText(getApplicationContext(),"The photo can added successfully but now you have to save it!", Toast.LENGTH_LONG).show();
